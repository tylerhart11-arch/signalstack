    ...
    <div className="space-y-8">
      ...
      <div className="grid gap-6 xl:grid-cols-[1.15fr_0.85fr]">
        <div className="space-y-6">
          ...
          {loading && !result ? (
            <Card title="Analyzing thesis" eyebrow="Parser">
              <p className="text-sm text-shell-muted">Mapping theme family, expression style, sectors, and confirming signals.</p>
            </Card>
          ) : null}
        ...
        <div className="space-y-6">
              ...
              {saved.length ? (
                saved.map((item) => (
                  <button
                    ...
                    className="w-full rounded-2xl border border-shell-border bg-black/10 p-4 text-left transition hover:border-shell-accent/30 hover:bg-shell-accent/5"
                  >
          ...
          <Card title="How This MVP Thinks" eyebrow="Transparent Logic">
