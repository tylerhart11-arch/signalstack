...
export default function RegimePage() {
  ...
  if (!current || !history) {
    return (
      <Card title="Loading regime engine" eyebrow="Macro Classification">
        <p className="text-sm text-shell-muted">Scoring inflation, labor, credit, curve shape, and risk appetite.</p>
      </Card>
    );
  }
  ...
  return (
    <div className="space-y-8">
      <SectionHeader
        ...
        action={<Badge tone="accent">As of {formatTimestamp(current.as_of)}</Badge>}
      />
