...
INDICATOR_DEFINITIONS = [
    ...
    IndicatorDefinition("us2y", "US 2Y Treasury", "Rates", "%", "fred", "DGS2", True, "absolute", 6.0, 5, 21, 63, 30, 2),
    IndicatorDefinition("us10y", "US 10Y Treasury", "Rates", "%", "fred", "DGS10", True, "absolute", 6.0, 5, 21, 63, 30, 2),
    IndicatorDefinition("s2s10s", "2s10s Slope", "Rates", "bps", "derived", None, True, "absolute", 5.0, 5, 21, 63, 30, 0),
    IndicatorDefinition("hy_spread", "High Yield Spread Proxy", "Credit", "%", "fred", "BAMLH0A0HYM2", True, "absolute", 8.0, 5, 21, 63, 30, 2),
    IndicatorDefinition("ig_spread", "Investment Grade Spread Proxy", "Credit", "%", "fred", "BAMLC0A0CM", True, "absolute", 4.0, 5, 21, 63, 30, 2),
    ...
    IndicatorDefinition("fed_funds_rate", "Fed Funds Rate", "Policy", "%", "fred", "FEDFUNDS", True, "absolute", 5.0, 1, 1, 3, 24, 2),
